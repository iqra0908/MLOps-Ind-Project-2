...
workspace_name = "mlopsproject2" # PLACEHOLDER
subscription_id = "20aaef89-f90e-4e8a-b1d3-21754fc74a4e" # PLACEHOLDER
resource_group = "mlopsproject2" # PLACEHOLDER
experiment_name = "project2-experiment-2" # PLACEHOLDER
iteration = "41"  # PLACEHOLDER
run_id = "AutoML_a47b80eb-54d4-4b11-a73e-0f9828eca620_41"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'project2','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':30,'featurization':{'_blocked_transformers':[],'_column_purposes':{},'_transformer_params':{'Imputer':[]},'_drop_columns':None},'hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'project2-experiment-2','path':'./sample_projects/project2-experiment-2','primary_metric':'normalized_mean_absolute_error','region':'eastus','resource_group':'mlopsproject2','subscription_id':'20aaef89-f90e-4e8a-b1d3-21754fc74a4e','task_type':'regression','validation_size':0.1,'test_size':0.1,'vm_type':'STANDARD_F4S_V2','workspace_name':'mlopsproject2','label_column_name':'Overall','tuning_config':{'enable_tuning_run':True},'enable_batch_run':True,'dataset_id':'c63ad103-5797-4130-824a-ae990479cd91'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Stack_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.stack_ensemble\",\"class_name\":\"StackEnsemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_mean_absolute_error','ensemble_iterations':15,'is_timeseries':False,'name':'project2-experiment-2','compute_target':'project2','subscription_id':'20aaef89-f90e-4e8a-b1d3-21754fc74a4e','region':'eastus','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_a47b80eb-54d4-4b11-a73e-0f9828eca620_41\",\"experiment_name\":\"project2-experiment-2\",\"workspace_name\":\"mlopsproject2\",\"subscription_id\":\"20aaef89-f90e-4e8a-b1d3-21754fc74a4e\",\"resource_group_name\":\"mlopsproject2\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Stack_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"c63ad103-5797-4130-824a-ae990479cd91\"}}" # PLACEHOLDER
